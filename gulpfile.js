...
/* minify js */
gulp.task('minify:js', ['babel'], function(cb) {
    pump([
        gulp.src(path.watch.jsDist),
        uglify(),
        gulp.dest(path.jsDist)], cb);
});
...
gulp.task('localhost', ['connect', 'connect:dist', 'watch']);
gulp.task('localhost:includes', ['connect', 'connect:dist', 'watch', 'watch:includes']);
gulp.task('localhost:scss', ['connect', 'connect:dist', 'watch']);
gulp.task('localhost:less', ['connect', 'connect:dist', 'watch:less']);
gulp.task('localhost:incscss', ['connect', 'connect:dist', 'watch', 'watch:includes']);
gulp.task('localhost:incless', ['connect', 'connect:dist', 'watch:less', 'watch:includes']);
gulp.task('localhost:icons', ['connect', 'connect:dist', 'watch', 'watch:icons']);
gulp.task('localhost:lessicons', ['connect', 'connect:dist', 'watch', 'watch:lessicons']);
gulp.task('localhost:incicons', ['connect', 'connect:dist', 'watch', 'watch:includes', 'watch:icons']);
gulp.task('localhost:inclessicons', ['connect', 'connect:dist', 'watch', 'watch:includes', 'watch:lessicons']);
